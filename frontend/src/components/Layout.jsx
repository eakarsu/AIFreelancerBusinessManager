...
const navItems = [
  ...
  { path: '/invoices', label: 'Invoices', icon: 'M9 14l6-6m-5.5.5h.01m4.99 5h.01M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16l3.5-2 3.5 2 3.5-2 3.5 2z' },
  ...
  { path: '/time-tracking', label: 'Time Tracking', icon: 'M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z' },
  ...
  { path: '/proposals', label: 'Proposals', icon: 'M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z' },
  ...
  { path: '/communications', label: 'Communications', icon: 'M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z' },
  { path: '/revenue-reports', label: 'Revenue & Reports', icon: 'M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z' },
  { path: '/goals', label: 'Goals & Milestones', icon: 'M13 10V3L4 14h7v7l9-11h-7z' },
  { path: '/custom-views', label: 'Freelance Views', icon: 'M4 6h16M4 10h16M4 14h16M4 18h16' },
];
      ...
      <aside className={`${sidebarOpen ? 'w-64' : 'w-20'} bg-white border-r border-gray-200 flex flex-col transition-all duration-300 flex-shrink-0`}>
        <div className="p-4 border-b border-gray-200 flex items-center gap-3">
          ...
          {sidebarOpen && (
            <div className="min-w-0">
              <h1 className="font-bold text-gray-900 text-sm leading-tight">AI Freelancer</h1>
        ...
        <nav className="flex-1 overflow-y-auto py-4 px-3 space-y-1">
          ...
          <div className="pt-4 mt-4 border-t border-gray-200">
            <p className={`px-3 mb-2 text-xs font-semibold text-purple-600 uppercase tracking-wider ${!sidebarOpen && 'sr-only'}`}>AI Features</p>
            <NavLink to={aiNavItem.path}
              className={({ isActive }) => `flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium transition-colors ${
                isActive ? 'ai-gradient text-white shadow-md' : 'text-purple-600 hover:bg-purple-50'
              }`}>
              <svg className="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d={aiNavItem.icon} />
              </svg>
              {sidebarOpen && <span>AI Center</span>}
            </NavLink>
            <NavLink to="/ai-business-intelligence"
              className={({ isActive }) => `flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium transition-colors mt-1 ${
                isActive ? 'ai-gradient text-white shadow-md' : 'text-purple-600 hover:bg-purple-50'
              }`}>
              <svg className="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z" />
              </svg>
              {sidebarOpen && <span>BI Insights</span>}
            </NavLink>
          </div>
        </nav>
        ...
        <div className="p-3 border-t border-gray-200">
          <button onClick={() => setSidebarOpen(!sidebarOpen)}
            className="w-full flex items-center gap-3 px-3 py-2 rounded-lg text-sm text-gray-500 hover:bg-gray-100">
