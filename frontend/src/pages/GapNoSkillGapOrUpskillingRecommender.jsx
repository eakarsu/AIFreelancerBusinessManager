...
// Auto-generated page for: No skill-gap or upskilling recommender

export default function GapNoSkillGapOrUpskillingRecommender() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-skill-gap-or-upskilling-recommender', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>No skill-gap or upskilling recommender</h1>
      <p style={{ color: '#666', marginBottom: '1.5rem' }}>No skill-gap or upskilling recommender</p>
      <form onSubmit={handleSubmit} style={{ marginBottom: '1.5rem' }}>
        ...
        >
          {loading ? 'Processing...' : 'Run No skill-gap or upskilling recommender'}
        </button>
      </form>
