...
// Auto-generated page for: No rate-optimization endpoint suggesting hourly rate moves

export default function GapNoRateOptimizationEndpointSuggesting() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-rate-optimization-endpoint-suggesting', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>No rate-optimization endpoint suggesting hourly rate moves</h1>
      <p style={{ color: '#666', marginBottom: '1.5rem' }}>No rate-optimization endpoint suggesting hourly rate moves</p>
      <form onSubmit={handleSubmit} style={{ marginBottom: '1.5rem' }}>
        ...
        >
          {loading ? 'Processing...' : 'Run No rate-optimization endpoint suggesting hourly rate moves'}
        </button>
      </form>
