...
// Auto-generated page for: No project-profitability-analysis endpoint (margin per clien

export default function GapNoProjectProfitabilityAnalysisEndpoi() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-project-profitability-analysis-endpoi', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>No project-profitability-analysis endpoint (margin per clien</h1>
      <p style={{ color: '#666', marginBottom: '1.5rem' }}>No project-profitability-analysis endpoint (margin per client/project type)</p>
      <form onSubmit={handleSubmit} style={{ marginBottom: '1.5rem' }}>
        ...
        >
          {loading ? 'Processing...' : 'Run No project-profitability-analysis endpoint (margin per clien'}
        </button>
      </form>
