...
// Auto-generated page for: Skill-demand marketplace integration aggregating Upwork/Topt

export default function CfSkillDemandMarketplaceIntegrationAgg() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch('/api/cf-skill-demand-marketplace-integration-agg', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>Skill-demand marketplace integration aggregating Upwork/Topt</h1>
      <p style={{ color: '#666', marginBottom: '1.5rem' }}>Skill-demand marketplace integration aggregating Upwork/Toptal/LinkedIn postings to surface emerging skill rates.</p>
      <form onSubmit={handleSubmit} style={{ marginBottom: '1.5rem' }}>
        ...
        >
          {loading ? 'Processing...' : 'Run Skill-demand marketplace integration aggregating Upwork/Topt'}
        </button>
      </form>
