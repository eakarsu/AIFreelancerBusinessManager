...
// Auto-generated page for: Limited file upload (no multer/object-store integration foun

export default function GapLimitedFileUploadNoMulterobjectStor() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-limited-file-upload-no-multerobject-stor', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>Limited file upload (no multer/object-store integration foun</h1>
      <p style={{ color: '#666', marginBottom: '1.5rem' }}>Limited file upload (no multer/object-store integration found for client deliverables)</p>
      <form onSubmit={handleSubmit} style={{ marginBottom: '1.5rem' }}>
        ...
        >
          {loading ? 'Processing...' : 'Run Limited file upload (no multer/object-store integration foun'}
        </button>
      </form>
