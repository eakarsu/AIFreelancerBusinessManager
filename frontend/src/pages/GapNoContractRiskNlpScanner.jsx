...
// Auto-generated page for: No contract-risk NLP scanner

export default function GapNoContractRiskNlpScanner() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-contract-risk-nlp-scanner', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>No contract-risk NLP scanner</h1>
      <p style={{ color: '#666', marginBottom: '1.5rem' }}>No contract-risk NLP scanner</p>
      <form onSubmit={handleSubmit} style={{ marginBottom: '1.5rem' }}>
        ...
        >
          {loading ? 'Processing...' : 'Run No contract-risk NLP scanner'}
        </button>
      </form>
