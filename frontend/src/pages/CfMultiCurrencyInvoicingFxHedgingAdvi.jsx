...
// Auto-generated page for: Multi-currency invoicing + FX hedging advisor using fxRates 

export default function CfMultiCurrencyInvoicingFxHedgingAdvi() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch('/api/cf-multi-currency-invoicing-fx-hedging-advi', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>Multi-currency invoicing + FX hedging advisor using fxRates </h1>
      <p style={{ color: '#666', marginBottom: '1.5rem' }}>Multi-currency invoicing + FX hedging advisor using fxRates module to recommend markups by client geography.</p>
      <form onSubmit={handleSubmit} style={{ marginBottom: '1.5rem' }}>
        ...
        >
          {loading ? 'Processing...' : 'Run Multi-currency invoicing + FX hedging advisor using fxRates '}
        </button>
      </form>
