...
// Auto-generated page for: No client-churn prediction

export default function GapNoClientChurnPrediction() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-client-churn-prediction', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>No client-churn prediction</h1>
      <p style={{ color: '#666', marginBottom: '1.5rem' }}>No client-churn prediction</p>
      <form onSubmit={handleSubmit} style={{ marginBottom: '1.5rem' }}>
        ...
        >
          {loading ? 'Processing...' : 'Run No client-churn prediction'}
        </button>
      </form>
